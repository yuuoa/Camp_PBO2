...
public class main
{
	public static void main(String[] args)
	{
		...
		Probe mio = new Probe ("Mio", "Mercury","JAXA (Japan)", "Orbiter");
		Stats mios = new Stats ("", "", "", "", "En Route", "June 8, 2018", 0);
		
		Probe venera = new Probe ("Venera 4", "Venus", "USSR (Soviet Union)", "Atmospheric");
		Stats veneras = new Stats ("", "", "", "", "Success", "June 12, 1967", 127);
		
		Probe ME = new Probe ("Mars Expres", "Mars", "ESA (European Union)", "Orbiter");
		Stats MEs = new Stats ("", "", "", "", "Success", "December 25, 2003", 5560);
		
		Probe aditya = new Probe ("Aditya-L1", "Sun", "ISRO (India)", "Orbiter");
